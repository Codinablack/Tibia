...
{
    public class FightModeChangedEventArgs : EventArgs
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:Tibia.Network.Game.Events.FightModeChangedEventArgs" /> class.
        /// </summary>
        ...
        public FightModeChangedEventArgs(CharacterSpawn characterSpawn, BattleStance battleStance, bool chaseMode, bool safeMode)
        {
